...
import PfpImage from "../../assets/raina-pfp.jpg"
      ...
      <div className="h-full w-full flex flex-col justify-center items-start gap-4 ">
        <div className="w-full flex flex-row justify-between items-start gap-2">
          ...
          <img
            ...
            alt=""
            className="h-20 md:h-40 w-20 md:w-40 object-cover rounded-full"
          />
        </div>
        <div className="">
          <p
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-2">
          ...
          <a
            href="/Raina-Saxena-Resume.pdf"
            download="Raina-Saxena-Resume.pdf"
            data-aos="fade-in"
            data-aos-delay={1500}
          >
            <ShimmerButton className="shadow-2xl my-3 md:mx-4">
